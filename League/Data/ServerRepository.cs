...
namespace VRrhythmLeague.Data
{
    ...
    public partial class ServerRepository
    {
        public static ServerRepository FromJson(string json) => JsonConvert.DeserializeObject<ServerRepository>(json, VRrhythmLeague.Data.Converter.Settings);
    }

    public static class Serialize
    {
        public static string ToJson(this ServerRepository self) => JsonConvert.SerializeObject(self, VRrhythmLeague.Data.Converter.Settings);
    }
