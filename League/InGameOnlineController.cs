...
namespace VRrhythmLeague
{
    ...
    public class InGameOnlineController : MonoBehaviour
    {
        ...
        public void SongFinished(StandardLevelScenesTransitionSetupDataSO sender, LevelCompletionResults levelCompletionResults)
        {
            ...
            if (true)
            {
                PluginUI.instance.leaguePlaylistFlowCoordinator.levelDifficultyBeatmap = difficultyBeatmap;
                PluginUI.instance.leaguePlaylistFlowCoordinator.levelResults = levelCompletionResults;


                PluginUI.instance.leaguePlaylistFlowCoordinator.lastHighscoreValid = playerLevelStats.validScore;
                PluginUI.instance.leaguePlaylistFlowCoordinator.lastHighscoreForLevel = playerLevelStats.highScore;
                PluginUI.instance.leaguePlaylistFlowCoordinator.UpdateUI(RoomState.Results);
