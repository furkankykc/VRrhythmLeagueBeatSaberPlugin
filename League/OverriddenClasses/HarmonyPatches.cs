...
namespace VRrhythmLeague.OverriddenClasses
{
    public static class HarmonyPatcher
    {
        ...
        {   
            if(instance == null)
                instance = new Harmony("com.andruzzzhka.VRrhythmLeague");

            Plugin.log.Debug("Patching...");
            foreach (var type in Assembly.GetExecutingAssembly().GetTypes().Where(x => x.IsClass && x.Namespace == "VRrhythmLeague.OverriddenClasses"))
            {
