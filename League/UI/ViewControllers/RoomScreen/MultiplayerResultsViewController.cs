...
namespace VRrhythmLeague.UI.ViewControllers.RoomScreen
{
    class MultiplayerResultsViewController : BSMLResourceViewController
    {
        ...
        public async void SetContent(IPreviewBeatmapLevel level)
        {
            ...
            if (PluginUI.instance.leaguePlaylistFlowCoordinator.levelDifficultyBeatmap != null)
            {
                var diffBeatmap = PluginUI.instance.leaguePlaylistFlowCoordinator.levelDifficultyBeatmap;
                var levelResults = PluginUI.instance.leaguePlaylistFlowCoordinator.levelResults;
                ...
                if (!PluginUI.instance.leaguePlaylistFlowCoordinator.lastHighscoreValid)
                {
                    scoreChangeValue.text = "--";
                    scoreChangeValue.color = Color.white;
                    scoreChangeIcon.gameObject.SetActive(false);
                ...
                {
                    if (PluginUI.instance.leaguePlaylistFlowCoordinator.lastHighscoreForLevel > levelResults.modifiedScore)
                    {
                        scoreChangeValue.text = (levelResults.modifiedScore - PluginUI.instance.leaguePlaylistFlowCoordinator.lastHighscoreForLevel).ToString();
                ...
                if (PluginManager.GetPluginFromId("BeatSaverVoting") != null)
                    BeatSaverVotingInterop.Setup(this, PluginUI.instance.leaguePlaylistFlowCoordinator.levelDifficultyBeatmap.level);
            }
            else
            {
