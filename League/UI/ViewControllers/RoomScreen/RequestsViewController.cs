...
namespace VRrhythmLeague.UI.ViewControllers.RoomScreen
{
    public class RequestsViewController : HotReloadableViewController, TableView.IDataSource
    {
        ...
        public override string ContentFilePath => @"C:\Users\kıyıkcı\Source\Repos\VRrhythmLeague\BeatSaberMultiplayer\UI\ViewControllers\RoomScreen\RequestsViewController.bsml";
