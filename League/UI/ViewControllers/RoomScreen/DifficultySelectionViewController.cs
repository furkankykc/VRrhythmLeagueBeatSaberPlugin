...
namespace VRrhythmLeague.UI.ViewControllers.RoomScreen
{
    class DifficultySelectionViewController : BSMLResourceViewController
    {
        ...
        public void UpdateViewController(bool isHost, bool perPlayerDifficulty)
        {
            ...
            charactertisticControlBlocker.gameObject.SetActive(true);
            //difficultyControlBlocker.gameObject.SetActive(!isHost && !perPlayerDifficulty);
            difficultyControlBlocker.gameObject.SetActive(true);
        ...
        public void SetSelectedSong(IPreviewBeatmapLevel selectedLevel)
        {
            ...
            {
                Plugin.log.Debug("selected song is beatmaplevel");
        ...
        private async void SetContent(IBeatmapLevel level)
        {
            ...
            Plugin.log.Critical("Loadinge geldim!");
            SetLoadingState(false);
        }
        public void UpdateContent()
        {
            if (_selectedLevel != null)
            {
                ...
                {
                    Plugin.log.Critical("_selectedDifficultyBeatmap null degil!");
        ...
        public void SetSelectedCharateristic(IconSegmentedControl sender, int index)
        {
            ...
            //}
            //else
                difficultyControl.SetTexts(diffBeatmaps.Where(x=>x.difficulty==difficulty).Select(x => x.difficulty.ToString().Replace("Plus", "+")).ToArray());
