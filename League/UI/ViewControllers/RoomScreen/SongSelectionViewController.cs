...
namespace VRrhythmLeague.UI.ViewControllers.RoomScreen
{
    ...
    class SongSelectionViewController : HotReloadableViewController, TableView.IDataSource
    {
        ...
        public override string ContentFilePath => @"C:\Users\kıyıkcı\Source\Repos\VRrhythmLeague\BeatSaberMultiplayer\UI\ViewControllers\RoomScreen\SongSelectionViewController.bsml";
        ...
        public void UpdateViewController(bool isHost, int requestedSongs)
        {
            ...
            //_requestSongButton.gameObject.SetActive(false);
