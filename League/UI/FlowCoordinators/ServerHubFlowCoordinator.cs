...
using VRrhythmLeague.UI.ViewControllers.ServerHubScreen;
using HMUI;
...
namespace VRrhythmLeague.UI.FlowCoordinators
{
    ...
    class ServerHubFlowCoordinator : FlowCoordinator
    {
        ...
        protected override void BackButtonWasPressed(ViewController topViewController)
        {
            ...
            {
                PluginUI.instance.leaguePlaylistFlowCoordinator.InvokeMethod("DismissFlowCoordinator", this, null, false);
            }
        }
    ...
    public class ServerHubClient : MonoBehaviour
    {
        ...
        public void Awake()
        {
            NetPeerConfiguration Config = new NetPeerConfiguration("VRrhythmLeague");
